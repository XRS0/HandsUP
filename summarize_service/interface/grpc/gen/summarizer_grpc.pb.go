...
const (
	SummarizerService_GenerateFull_FullMethodName = "/gen.SummarizerService/GenerateFull"
)
...
type SummarizerServiceClient interface {
	GenerateFull(ctx context.Context, in *SummarizeRequest, opts ...grpc.CallOption) (*SummarizeResponse, error)
}
...
func (c *summarizerServiceClient) GenerateFull(ctx context.Context, in *SummarizeRequest, opts ...grpc.CallOption) (*SummarizeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SummarizeResponse)
	err := c.cc.Invoke(ctx, SummarizerService_GenerateFull_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SummarizerServiceServer interface {
	GenerateFull(context.Context, *SummarizeRequest) (*SummarizeResponse, error)
...
func (UnimplementedSummarizerServiceServer) GenerateFull(context.Context, *SummarizeRequest) (*SummarizeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateFull not implemented")
}
...
func _SummarizerService_GenerateFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SummarizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SummarizerServiceServer).GenerateFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SummarizerService_GenerateFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SummarizerServiceServer).GenerateFull(ctx, req.(*SummarizeRequest))
	}
...
var SummarizerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GenerateFull",
			Handler:    _SummarizerService_GenerateFull_Handler,
		},
	},
